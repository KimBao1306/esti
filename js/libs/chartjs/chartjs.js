...
!(function (t, e) {
		...
		for (let t = h, i = h; t <= d; ++t)
			(m = e[t % a]),
				m.skip ||
					...
					(x = p));
		return (
			null !== _ && g.push(vn({start: _, end: d, loop: u, count: a, style: f})),
			g
		);
	}
	function Mn(t, e) {
			...
			return !1 !== n || e
				? (function (t, e, i, n) {
						...
						for (let a = 0; a < e.length; a++) {
							const r = e[a],
								l = Rn(i[r.id], n);
							null !== l && o.push({plugin: r, options: Ln(t.config, r, l, s)});
						}
						return o;
				  })(t, o, n, e)
				: [];
			...
			i &&
				...
				J(s, (i) => {
					...
					if (a in n && n[a].type === l) c = n[a];
						...
						(c = new (An.getScale(l))({id: a, type: l, ctx: t.ctx, chart: t})),
							(n[c.id] = c);
					}
					c.init(s, e);
				}),
	...
	(mo.id = 'radar'),
		...
		(mo.overrides = {aspectRatio: 1, scales: {r: {type: 'radialLinear'}}});
	class xo extends fo {}
	(xo.id = 'scatter'),
	...
	function wo(t, e) {
		const {x: i, y: n, startAngle: o, endAngle: s, pixelMargin: a} = e,
			...
			l = e.innerRadius + a,
			{outerStart: c, outerEnd: h, innerStart: d, innerEnd: u} = yo(
				e,
				l,
				r,
				s - o
			...
			labels: {
				...
				generateLabels(t) {
					const e = t.data.datasets,
						{
							labels: {usePointStyle: i, pointStyle: n, textAlign: o, color: s},
						} = t.legend.options;
